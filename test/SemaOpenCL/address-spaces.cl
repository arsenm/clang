...
__kernel void foo(__global int *gip) {
  ...
  int *ip;
  ip = gip; // expected-error {{assigning '__global int *' to '__private int *' changes address space of pointer}}
  ip = &li; // expected-error {{assigning '__local int *' to '__private int *' changes address space of pointer}}
  ip = &ci; // expected-error {{assigning '__constant int *' to '__private int *' changes address space of pointer}}
}
